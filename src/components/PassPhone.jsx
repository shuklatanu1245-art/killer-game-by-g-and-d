    ...
    <div className="metallic-panel p-8 max-w-md w-full text-center relative z-10">
      ...
      {!hasSeen ? (
        <button 
          ...
          className="w-full flex items-center justify-center gap-3 metallic-btn metallic-btn-red py-4 px-6 rounded-xl"
        >
          <Eye size={20} />
          SHOW MY ROLE
        </button>
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <button 
            disabled
            className="w-full flex items-center justify-center gap-3 bg-[#0B0F19] text-gray-600 font-black tracking-widest py-4 px-6 rounded-xl cursor-not-allowed border border-white/5"
          >
