    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="glass rounded-3xl p-8 max-w-md w-full text-center relative z-10 shadow-2xl border border-white/5">
        ...
        <div className="space-y-4">
          ...
          <button className="w-full group flex items-center justify-center gap-3 bg-surface hover:bg-surface/80 text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 border border-white/10 hover:border-white/20 hover:scale-[1.02] active:scale-95">
